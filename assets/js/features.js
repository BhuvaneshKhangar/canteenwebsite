    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">DYP</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">DYPIEMR</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>D.Y.Patil Pratishthan Educational complex, 
                        Akurdi is in proximity to Pimpri Chinchwad Industrial belt, 
                        IT Park of Hinjewadi & Automobile hub of Talegaon. 
                        The Pratishthan is spread over 29 acres of land at Akurdi, 
                        which is in the vicinity of Akurdi Railway station & Mumbai - Pune Express highway.
                        The Pratishthan is introducing new engineering college 
                        “Dr. D. Y. Patil Institute of Engineering, Management and Research”(DYPIEMR) 
                        from the Academic Year 2012-13.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/dypiemrakurdi/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/dypiemr3/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://www.dypiemr.ac.in/" target="_blank">DYPIEMR</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91–20–27654470</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>dyppeca@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Dr. D. Y. Patil Institute of Engineering Management And Research,
                            Akurdi, Pune-411044</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: <a href="https://www.dypiemr.ac.in/courses/academics">https://www.dypiemr.ac.in/courses/academics</a></p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed By <a href="#">Group-21</a></div>
                </main>
            </section>
        `;
        })
                ...
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91–20–27654470</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>info@dypiemr.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Dr. D. Y. Patil Institute of Engineering Management And Research,
                            Akurdi, Pune-411044</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: <a href="https://www.dypiemr.ac.in/courses/academics">https://www.dypiemr.ac.in/courses/academics</a></p></li>
                        </ul>
